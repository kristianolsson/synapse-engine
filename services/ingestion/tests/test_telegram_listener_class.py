...
from services.ingestion.telegram_listener import TelegramListener, config
...
class TestTelegramListenerClass(unittest.TestCase):
    ...
    @patch("services.ingestion.telegram_listener.Application")
    ...
    def test_run_no_token(self):
        ...
        with patch("services.ingestion.telegram_listener.Application") as mock_app_cls:
            self.listener.run()
            mock_app_cls.assert_not_called()

    @patch("services.ingestion.telegram_listener.asyncio")
