...
- [ ] Task: specific - Update `requirements.txt` to include `pytest-cov` and install dependencies.
- [ ] Task: specific - Create or update `pytest.ini` to configure test discovery and coverage reporting.
